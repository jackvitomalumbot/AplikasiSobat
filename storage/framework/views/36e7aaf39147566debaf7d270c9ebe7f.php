...
<?php $__env->startSection('auth_subtitle', 'Buat akun mahasiswa baru'); ?>
...
unset($__errorArgs, $__bag); ?>" id="reg-name" name="nama" value="<?php echo e(old('nama')); ?>" placeholder="Nama lengkap Anda" required>
...
unset($__errorArgs, $__bag); ?>" id="reg-universitas" name="universitas" value="<?php echo e(old('universitas')); ?>" placeholder="Contoh: Universitas Indonesia" required>
...
unset($__errorArgs, $__bag); ?>" id="reg-nim" name="nim" value="<?php echo e(old('nim')); ?>" placeholder="Nomor Induk Mahasiswa" required>
        <?php $__errorArgs = ['nim'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="reg-email" name="email" value="<?php echo e(old('email')); ?>" placeholder="email@universitas.ac.id" required>
...
unset($__errorArgs, $__bag); ?>" id="reg-password" name="password" placeholder="Min. 8 karakter" required>
...
<div class="auth-footer">
    Sudah punya akun? <a href="<?php echo e(url('/login')); ?>"><strong>Masuk di sini</strong></a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AplikasiSobatMedis\resources\views/auth/register.blade.php ENDPATH**/ ?>