...
<div class="grid grid-4">
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e(number_format($totalMahasiswa)); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e(number_format($totalPengajar)); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e(number_format($totalKelas)); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e(number_format($totalEnrollments)); ?></div>
        <div class="stat-label">Total Enrollment</div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AplikasiSobatMedis\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>