...
<body class="has-sidebar">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ url('/admin/mahasiswa') }}" class="sidebar-link {{ request()->is('admin/mahasiswa') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/pengajar') }}" class="sidebar-link {{ request()->is('admin/pengajar') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/info-pengajar') }}" class="sidebar-link {{ request()->is('admin/info-pengajar') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/prestasi') }}" class="sidebar-link {{ request()->is('admin/prestasi') ? 'active' : '' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg>
                Prestasi
            </a>
