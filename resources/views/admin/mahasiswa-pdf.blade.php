...
<body>
    ...
    <div class="stats">
        ...
        <div class="stat-box">
            <div class="value">{{ $mahasiswaList->filter(fn($m) => $m->email_verified_at)->count() }}</div>
            <div class="label">Email Terverifikasi</div>
        </div>
        <div class="stat-box">
            <div class="value">{{ $mahasiswaList->unique(fn($m) => $m->mahasiswaDetail->universitas ?? '')->count() }}</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $mhs->enrollments->count() }}</td>
